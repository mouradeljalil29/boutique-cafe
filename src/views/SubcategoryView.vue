<template>
  <div class="page" v-if="subcategory && category">
    <div class="container">
      ...
      <!-- Liens internes vers d'autres sous-catégories -->
...
import { getAllSubcategory, getSubcategoryProducts, getCategoryBySlug } from '@/data/products.js'
...
onMounted(updateSEO)
watch(() => route.params, updateSEO, { deep: true })
</script>
