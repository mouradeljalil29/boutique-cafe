  ...
  <div class="page">
    <div class="container">
      ...
      <div class="seo-text-block">
        ...
        <p>Notre catalogue est organisé par <NuxtLink to="/origines">pays d'origine</NuxtLink>, par <NuxtLink to="/torrefaction">profil de torréfaction</NuxtLink> et par <NuxtLink to="/certifications">certification</NuxtLink> (Bio, Commerce Équitable).</p>
      </div>
    </div>
  </div>
</template>
...
setMeta({
  title: 'Catalogue Cafés de Spécialité en Grain | Grains & Origines',
  description: 'Parcourez notre catalogue de cafés de spécialité en grain. Éthiopie, Colombie, Brésil, Guatemala. Torréfaction artisanale. Certifiés Bio et Équitable. Commande en ligne.',
  canonical: '/catalogue'
})
</script>
